...
กรณีเฉลยถูกมากกว่า 1 ข้อ: หากโจทย์หรือเฉลยที่ให้มาระบุชัดว่าข้อนี้มีตัวเลือกที่ถูกต้องได้มากกว่า 1 ข้อ หรือเป็นข้อที่ให้คะแนนฟรี ให้ขึ้นต้นย่อหน้าด้วยแท็ก **[⚠️ หมายเหตุข้อสอบจริง]:** ชี้แจงสั้นๆ ว่าทำไมถูกได้ทั้งคู่ และทำไมระบบจึงตั้ง${answer ? ` "${answer}"` : 'ข้อที่เลือก'}เป็นเฉลยหลัก (เช่น First-line / Gold standard ตาม Guideline ปัจจุบัน) แล้วจึงอธิบายกลไกต่อในย่อหน้าเดียวกัน ห้ามอนุมานเงื่อนไขนี้เองถ้าไม่มีหลักฐานชัดเจน และห้ามใส่ /// ในข้อความหมายเหตุ`,
